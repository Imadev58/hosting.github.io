...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-gray-50 dark:bg-gray-900">
      <Head>
        <title>Welcome to S4 Hosting</title>
        <meta name="description" content="Welcome to S4 Hosting, the beta platform for all your hosting needs." />
      ...
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        <p className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
          ...
          <code className="font-mono font-bold">page.txs</code>
        </p>
      ...
      <div className="relative flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-6 text-center text-blue-600 dark:text-blue-400">
          Welcome to S4 Hosting
        </h1>
        <p className="text-xl mb-6 text-center text-gray-700 dark:text-gray-300">
          This site is currently in beta. Feel free to explore and host your projects with us!
        </p>
        <nav className="mb-8">
